...
<body>
    ...
    <div id="registration" class="w3-container">
        <br><br><br>
        <form action="/store-leave-type" method="post" class="w3-container w3-card-4 w3-padding-16 w3-white w3-round">
            @csrf
            <div class="form-row">
                <div class="form-group">
                    <label for="name">type</label>
                    <input class="w3-input w3-border" type="text" placeholder="Enter leave type"
            ...
            <p>
                <button class="w3-button w3-light-grey w3-section w3-block w3-padding" type="submit"
                    id="submit-button">add leave type</button>
            </p>
        </form>
    </div>
