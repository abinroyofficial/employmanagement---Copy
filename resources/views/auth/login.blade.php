...
<body>
    ...
    <div id="login" class="w3-container">
        ...
        <form action="{{ route('login') }}" method="post" class="w3-container w3-card-4 w3-padding-16 w3-white w3-round">
            @csrf
            ...
            <p>
                <button class="w3-button w3-light-grey w3-section w3-block w3-padding" type="submit">Login</button>
            </p>

            <p class="w3-center">
                <a href="{{route('register')}}" class="w3-text-blue">Don't have an account? Register here</a>
            </p>
            <p class="w3-center">
                <a href="/forgot-password" class="w3-text-blue">forgot password</a>
            </p>
        </form>
    </div>
