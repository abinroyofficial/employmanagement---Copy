    ...
    <div class="task-detail" id="task-detail">
        <div class="card task-card">
            <div class="card-body">
                ...
                <h3 id="phone" class="card-title"></h3>
                <label for="">WORK FROM TO</label>
                <p id="work_time_from" class="card-text"></p>
                <label for="">SALARY</label>
                <p id="salary" class="card-text"></p>
                <label for="">LEAVE ALLOCATED</label>
                <p id="leave" class="card-text"></p>
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.data) {
                            ...
                            $('#task-id').text(response.data.employ_id);
                            $('#phone').text(response.data.phone);
                            $('#work_time_from').text(response.data.work_time_from + ' to ' +
                                response.data.work_time_to);
                            $('#salary').text(response.data.salary);
                            $('#leave').text(response.data.leave);
